...
function SuccessCard({ title, description, image }) {
    return (
        <div
            className="relative h-[450px] w-full flex items-end overflow-hidden text-center text-white shadow-lg shadow-black/30 bg-contain bg-no-repeat bg-center transition-transform duration-700  ease-out hover:items-center hover:bg-opacity-80 focus-within:items-center focus-within:bg-opacity-80 border-y-4 border-yellow-400"
